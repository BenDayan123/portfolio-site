...
const Eclipse: React.FC = () => {
  return (
    <div
      className={cn(
        "pointer-events-none scale-y-100 -mt[200px] select-none relative w-1/2 max-lg:w-full mx-auto h-[600px] overflow-hidden [mask-image:radial-gradient(circle,_black,_transparent_80%)]",
        `before:content-[""] before:inset-0 before:absolute before:[background:radial-gradient(circle_at_bottom_center,_#7877C6,_transparent_70%)] before:opacity-40`,
        `after:content-[""] after:absolute after:bg-background-dark after:w-[200%] after:-left-1/2 after:[aspect-ratio:1_/_0.7] after:rounded-[50%] after:border-t after:border-t-[rgba(120,_118,_197,_0.4)] after:top-1/2`
      )}
    >
      <svg
        ...
        height="731"
        fill="none"
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 [mask-image:radial-gradient(circle_at_center_bottom,_black,_transparent)]"
      >
